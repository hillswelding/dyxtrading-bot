...
"""
X is the value of the data point,  Formualr : Z = ((X-mean)/std)
mean
...
def calculate_cointegration_intercept(series_1, series_2):
...
"""
A hedge ratio of 1:1 indicates a perfect hedge, meaning that the value of the 
hedging instrument completely offsets the changes in value of the underlying asset. 
"""
